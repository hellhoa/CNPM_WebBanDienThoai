 ...
 <body>
  	...
  	<div class="container">
        <div class="chungtatca">
  			<img src="./image/imagelaptop1.png" alt="" width="100%">
  			<img src="./image/imagelaptop2.png" alt="" width="100%">
    		<img src="./image/imagelaptop3.png " alt="" width="100%">
    		<h1>LAPTOP</h1>
			<ul class="dschung">
				<%int i =1; %>
