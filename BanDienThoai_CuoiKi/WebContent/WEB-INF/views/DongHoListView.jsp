 ...
 <body>
  	...
  	<div class="container">
        <div class="chungtatca">
  			<img src="./image/1200-350-1200x350-3.png" alt="" width="100%">
  			<img src="./image/1200-350-1200x350-18.png" alt="" width="100%">
    		<img src="./image/1200-350-1200x350-20.png " alt="" width="100%">
    		<h1>ĐỒNG HỒ</h1>
			<ul class="dschung">
				<%int i =1; %>
