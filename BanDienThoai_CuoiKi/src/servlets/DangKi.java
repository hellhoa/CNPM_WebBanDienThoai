...
public class DangKi extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String nhaplaimatkhau = new String( request.getParameter("nhaplaimatkhau").getBytes("ISO-8859-1"),"UTF-8");
        String tenkhachhang1=request.getParameter("tenkhachhang");
        String tenTK1 =  request.getParameter("tenTK");
        String matkhau1 = request.getParameter("matkhau");
        String diachigiaohang1 =  request.getParameter("diachigiaohang");
        String nhaplaimatkhau1 = request.getParameter("nhaplaimatkhau");
        if(tenkhachhang1 =="" || tenTK1 =="" || matkhau1 == "" || diachigiaohang1 =="" || nhaplaimatkhau1 =="")
        {
        	String thogbaoString = "tạo tk ko thành công";
        	request.setAttribute("thongbao", thogbaoString);
